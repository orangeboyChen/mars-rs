...
// what `import MarsXlogFFI` gives a caller is the C surface itself: pointers to
...
// Re-exported so that `import MarsXlog` also gives the C symbols.
@_exported import MarsXlogFFI
