...
/**
 * 基础事件通知类 — every `native` here is one
 * `Java_io_github_orangeboychen_marsrs_BaseEvent_*` symbol of `mars-jni`.
 *
...
public class BaseEvent {
    ...
    public static native void onInitConfigBeforeOnCreate(final int packerEncoderVersion);
