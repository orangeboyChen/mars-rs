...
use mars_comm::message_queue::{
    ...
    create_message_queue, destroy_message_queue, found_message, install_async_handler,
    install_message_handler, install_message_handler as install, pending_message_count,
    post_message, post_message_at_first, singleton_message, wait_message, KNullPost, Message,
    MessageHandler, MessageTiming, MessageTitle, RunLoop,
};
