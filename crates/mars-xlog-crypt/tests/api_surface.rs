//! Integration test: drives the whole public surface of `mars-xlog-crypt`
//! from *outside* the crate, so an accidental visibility change shows up here.

use mars_xlog_core::AutoBuffer;
use mars_xlog_crypt::magic;
use mars_xlog_crypt::{LogCrypt, CLIENT_PUBKEY_LEN, HEADER_LEN, TAILER_LEN, TEA_BLOCK_LEN};
