//! End-to-end tests for the public `mars-xlog-buffer` API.
//!
...
use mars_xlog_buffer::{get_period_logs, get_period_logs_with_timeout_ms, CompressMode, LogBuffer};
use mars_xlog_core::{local_hour, AutoBuffer};
